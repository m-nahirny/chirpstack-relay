...
const std::string CLIENT_ID("wisblock1_subcribe");
...
//			std::cout << "\tpayload: '" << msg->to_string() << "'\n" << std::endl;
		...
		try
		{
			if (jmsg["data"] != NULL)
			{
/*				std::cout << "time: " << jmsg["rxInfo"][0]["time"] << "\n";
				std::cout << "rssi: " << jmsg["rxInfo"][0]["rssi"] << "\n";
				std::cout << "LoRaSNR: " << jmsg["rxInfo"][0]["loRaSNR"] << "\n";
				std::cout << "channel: " << jmsg["rxInfo"][0]["channel"] << "\n";
				std::cout << "CRC Status: " << jmsg["rxInfo"][0]["crcStatus"] << "\n";
*/
//				if (jmsg["rxInfo"][1]["time"] != NULL)
//				{
	//				std::cout << "time 2: " << jmsg["rxInfo"][1]["time"] << "\n";
		//			std::cout << "rssi 2: " << jmsg["rxInfo"][1]["rssi"] << "\n";
			//		std::cout << "LoRaSNR 2: " << jmsg["rxInfo"][1]["loRaSNR"] << "\n";
				//	std::cout << "channel 2: " << jmsg["rxInfo"][1]["channel"] << "\n";
				//}

//				std::cout << "latitude: " << jmsg["rxInfo"][0]["location"]["latitude"] << "\n";
//				std::cout << "longitude: " << jmsg["rxInfo"][0]["location"]["longitude"] << "\n";
//				std::cout << "altitude: " << jmsg["rxInfo"][0]["location"]["altitude"] << "\n";

/*				std::cout << "frequency: " << jmsg["txInfo"]["frequency"] << "\n";
				std::cout << "spreading factor: " << jmsg["txInfo"]["loRaModulationInfo"]["spreadingFactor"] << "\n";
*/				
//				std::cout << "data: " << jmsg["data"] << "\n";
